...
export default function FaqHero() {
  return (
    ...
    >
      ...
      <Image
        src={HERO_IMG}
        alt="Dholera smart city sunset field background"
        fill
        priority
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center px-4 sm:px-6">
        <motion.div variants={textVariants} className="flex flex-col items-center gap-4 md:gap-5">
          {/* Title */}
          <h1 className="font-serif text-[36px] sm:text-[48px] md:text-[56px] lg:text-[64px] font-semibold text-white tracking-[-1.5px] leading-tight">
